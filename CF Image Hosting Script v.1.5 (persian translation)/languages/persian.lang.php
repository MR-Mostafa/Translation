 ...
 */
	...
	$lang["site_gallery_report"]						= 'گزارش دادن';
 ...
 */
	...
	$lang["site_search_results"]						= 'نتیجه جستجو برای';
	$lang["site_search_no_results"]						= 'متاسفیم، هیچ نتیجه ای برای';
	$lang["site_search_no_results2"]					= 'یافت نشد.';
 ...
 */
	...
	$lang["site_privacy_policy_line1"]					= 'بر طبق این توافقنامه این سایت متعهد می شود به کلیه حقوق اختصاصی کاربران احترام بگذارد و در این توافقنامه از دیگر کاربران نیز می خواهد که آنها نیز همین کار را انجام دهند. تمام تلاش ما بر اینست که رضایت شما کاربران را فراهم آوریم، چنانچه اعتقادتان بر این می باشد که حقوق انحصاری شما در این سایت مورد تجاوز قرار گرفته است، حتما ما را در جریان بگذارید.';
	$lang["site_privacy_policy_line2"]					= 'ما بعنوان مسئولین این سایت، تلاش می کنیم که اطلاعات شخصی ای را که شما در اختیار ما می گذارید حفظ نماییم و این منطبق با سیاست حفظ اطلاعات خصوصی شما از جانب ماست. تحت هر شرایطی اطلاعاتی که شما برای ما فراهم کرده اید، محرمانه فرض می شود و به هیچ عنوان توسط ما منتشر نخواهد شد.';

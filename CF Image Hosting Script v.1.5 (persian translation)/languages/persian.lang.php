 ...
 *   Description: CF Image Hosting Script v.1.4.2 (except admin panel) is Compatibled with persian language. if you found any problem, Contact Us. also i thank the administrator of persianscript.ir (M.Majidi) for translating the Previous version of this script.
 ...
 * Upload images msg
 */
 	$lang["upload_duplicate_found"]		= 'One or more of the images you are uploading is a duplicate of a image what has been uploaded before.';
 ...
 * Index/Home Page
 */
 	$lang["site_index_des"]										= 'Upload your images/photos to our free image hosting servers and share them with your friends, family,and collegues.';
	...
	$lang["site_index_Remote_image"]						= 'URL of the image you would like to upload';
 ...
 */
	...
	$lang["site_contact_des"]									= 'Please include a valid email so we can contact you should we need to.<br/>Any email addresses submitted via this site will not be distributed.';
